...
System Workflow
Input data or request is received
Data is structured and processed
Sent to ChatGPT API for analysis
AI determines the most relevant category/department
Request is routed to the correct database/handler
Output is organized and ready for action
Technologies Used
Java
ChatGPT API (OpenAI)
Database Processing
